...
class CodeRun extends Vue {
  ...
  handleClick(p) {
    if (p === 4) {
      ...
      this.$el.querySelector("#running-views").$empty().appendChild(el);
      ...
      <div class="editor-run">
        <div class="editor-left">
          <div style="margin-top: 10px">
            ...
            <button class="toRun" onClick={this.handleClick.bind(this, 3)}>
              运行
            </button>
            <button class="toRun" onClick={this.handleClick.bind(this, 4)}>
              返回
            </button>
          </div>
